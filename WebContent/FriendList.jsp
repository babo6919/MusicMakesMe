...
<form action="./FriendMusicAction.me" method="post">
      <table style="float: left;">
         <tr>
            ...
            <td rowspan="3">
               <div class="image">
                     <img src="ProfileImage/${friendList.PROFILE_IMG}"
                        style="width:250px; border-radius:50%; margin-top:70px;
                        margin-left:90px;">
               </div>               
            </td>
            <td style="position:absolute; margin-top:135px; margin-left:58px;">
               	아이디:${friendList.FRIEND_ID}
            </td>
            <!----------------------------------------------------------------->                        
            <td>
                  <input type="submit" value="친구 노래 듣기" id="add"> 
                  <input type="hidden" name="friendList" value="${friendList.FRIEND_ID}">
            </td>
